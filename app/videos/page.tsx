        ...
        <section className="relative py-20 overflow-hidden">
          ...
          <div className="relative max-w-6xl mx-auto px-4">
            ...
            <div className="flex items-center gap-4 mb-6">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white">Videos Institucionales</h1>
            </div>
            ...
            <div className="mt-8 inline-flex items-center gap-3 px-4 py-2 rounded-full bg-white/10 backdrop-blur-sm border border-white/20">
              ...
              <span className="text-sm text-white/90">{videos.length} videos disponibles</span>
            </div>
          </div>
        </section>
