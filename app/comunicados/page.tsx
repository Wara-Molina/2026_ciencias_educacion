      ...
      <div className="min-h-screen bg-background">
        ...
        <section className="relative py-12 sm:py-20 overflow-hidden">
          ...
          <div className="relative max-w-6xl mx-auto px-4">
            <Link href="/" className="inline-flex items-center gap-2 text-sm text-white/80 hover:text-white mb-6 sm:mb-8 transition-colors group">
            ...
            <div className="flex items-center gap-4 mb-6">
              ...
              <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-white">Comunicados Institucionales</h1>
            </div>
            ...
            <p className="text-base sm:text-lg md:text-xl text-white/90 max-w-3xl leading-relaxed">
              ...
              <span className="font-semibold text-white">{sanitizeText(institucion?.institucion_nombre || 'nuestra institución', 100)}</span>
            </p>
            ...
            <div className="mt-6 sm:mt-8 inline-flex items-center gap-3 px-4 py-2 rounded-full bg-white/10 backdrop-blur-sm border border-white/20">
              ...
              <span className="text-sm text-white/90">{comunicados.length} comunicados disponibles</span>
            </div>
          </div>
        </section>
