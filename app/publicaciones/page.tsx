...
function PublicacionesContent() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        // ✅ Filtrar: excluir estado "0" Y excluir tipo "SEDES"
        const publicacionesData: Publicacion[] = (publiRes.data.upea_publicaciones || [])
          .filter((p: any) => 
            p.publicaciones_estado !== "0" && 
            p.publicaciones_tipo !== "SEDES"  // ✅ EXCLUIR SEDES
          );
        ...
        // ✅ Extraer categorías únicas (sin SEDES)
  ...
  }, [busqueda, categoriaActiva, publicaciones, paginaActual, searchParams, router]);
